...
DELETE FROM sodas
WHERE (product_name, description, cost, current_quantity, max_quantity) IN (
    ('Fizz', 'An effervescent fruity experience with hints of grape and coriander.', 1, 100, 100),
